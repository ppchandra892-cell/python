...
while i<=len(enames)-1:
    print(enames[i]["id"], enames[i]["ename"])
    i=i+1 """
#WAP NO OF MALE COUNTS
male_count=0
female_count=0 
bi_gender=0
for ename in enames:
    ...
    elif ename['gender']=="Male":
        male_count=male_count+1
    else :
        bi_gender+=1
print("no of females is:",female_count,"male",male_count)
print("no of males is:",male_count)
print("no of bigender is:",bi_gender)
